...
{
    internal sealed class WaterSurfaceProfile : IValidateData
    {
        #region Properties
        public bool IsValid { get; private set; }
        public double[] Probabilities { get; }
        public Dictionary<double, Statistics.CurveIncreasing> Profiles { get; }
        #endregion

        #region Constructor
        public WaterSurfaceProfile(Dictionary<double, Statistics.CurveIncreasing> profiles, double[] probabilities)
        {
            Profiles = profiles;
