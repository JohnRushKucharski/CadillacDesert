...
{
    public sealed class InteriorStageFrequency : ComputationPointFunctionBase, IFunctionCompose
    {
        #region Properties
        ...
        #region Constructor
        internal InteriorStageFrequency(IFunctionBase function) : base(function)
        {
            Type = ComputationPointFunctionEnum.InteriorStageFrequency;
            IsValid = Validate();
        }
        #endregion
