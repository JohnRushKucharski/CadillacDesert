...
namespace ModelTests.InputsTests.FunctionsTests.ImplementationsTests
{
    ...
    public class ExteriorStageFrequencyTests
    {
        ...
        {
            ExteriorStageFrequency testExteriorStageFrequency = (ExteriorStageFrequency)ComputationPointFunctionFactory.CreateNew(defaultFrequencyOrdinates, ComputationPointFunctionEnum.ExteriorStageFrequency);
        ...
        {
            ExteriorStageFrequency testExteriorStageFrequency = (ExteriorStageFrequency)ComputationPointFunctionFactory.CreateNew(defaultCurveIncreasing, ComputationPointFunctionEnum.ExteriorStageFrequency);
