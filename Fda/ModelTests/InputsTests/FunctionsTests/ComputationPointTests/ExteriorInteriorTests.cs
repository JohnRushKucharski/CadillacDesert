...
namespace ModelTests.InputsTests.FunctionsTests.ImplementationsTests
{
    ...
    public class ExteriorInteriorTests
    {
        ...
        public void Validation_NotHigherInteriorStagesReturnsTrue()
        {
            ...
            Model.Inputs.Functions.ComputationPoint.ExteriorInteriorStage testFunction = new Model.Inputs.Functions.ComputationPoint.ExteriorInteriorStage(testOrdinates, testOrdinates.Ordinates);
