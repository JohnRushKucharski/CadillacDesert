...
namespace ModelTests.InputsTests.FunctionsTests.ImplementationsTests
{
    ...
    public class InflowFrequencyTests
    {
        ...
        private IFunctionCompose testInflowFrequency = ComputationPointFunctionFactory.CreateNew(new FrequencyFunction(new Statistics.LogPearsonIII(1, 0.1, 0.1, 100)));
        #endregion
        ...
        {
            IFunctionCompose actual = testInflowFrequency.Compose(ComputationPointFunctionFactory.CreateNew(testOrdinates, testOrdinates.Ordinates, ComputationPointFunctionEnum.InflowOutflow));
            Assert.AreEqual(typeof(OutflowFrequency), actual.GetType());
        }
        [TestMethod()]
        public void Compose_RatingInputReturnsExteriorStageFrequency()
        {
            IFunctionCompose actual = testInflowFrequency.Compose(ComputationPointFunctionFactory.CreateNew(testOrdinates, testOrdinates.Ordinates, ComputationPointFunctionEnum.Rating));
        ...
        public void Compose_RatingInputConvertsUseTypeToOutflowFrequency()
        {
            ...
            IFunctionCompose actual = inflowFrequencyCopy.Compose(ComputationPointFunctionFactory.CreateNew(testOrdinates, testOrdinates.Ordinates, ComputationPointFunctionEnum.Rating));
            Assert.AreEqual(ComputationPointFunctionEnum.OutflowFrequency, inflowFrequencyCopy.UseType);
        }
